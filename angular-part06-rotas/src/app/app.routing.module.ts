...
import {isUserLoggedGuardFn} from "./guard/auth.guard";
...
const APP_ROUTES: Routes = [
  ...
  {path: "cursos", canActivate:[isUserLoggedGuardFn], loadChildren: () => import("./cursos/cursos.module").then(modulo => modulo.CursosModule)},

  { path: "alunos", canActivate:[isUserLoggedGuardFn], loadChildren: () => import("./alunos/alunos.module").then(modulo => modulo.AlunosModule)},
  ...
  { path: '', canActivate:[isUserLoggedGuardFn], component: HomeComponent}
];
